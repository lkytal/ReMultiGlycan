...
namespace COL.MassLib.MascotParser
{
	public class MascotDAT
	{
		...
		private Dictionary<int, Summary> _SummaryDict; //Key: Query Num;
		private Dictionary<int, string> _ModificationsDict; //Key: Modification Index;
		private Dictionary<int, List<Peptides>> _PeptideDict; //Key:Query Num;
