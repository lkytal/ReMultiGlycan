...
namespace COL.MultiGlycan
{
	internal class QuantitationPeak
	{
		...
		private float _totalProtonatedIntensity = 0;
		...
		public string GlycanKey => _glycanKey;
		...
		{
			get => _protonatedPeaks;
			set => _protonatedPeaks = value;
		}

		public Dictionary<string, List<Tuple<float, float>>> OtherAdductsPeaks => _otherAdductsPeaks;
