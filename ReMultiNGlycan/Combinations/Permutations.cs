...
namespace Facet.Combinatorics
{
	...
	public class Permutations<T> : IMetaCollection<T>
	{
		...
		public class Enumerator : IEnumerator<IList<T>>
		{
			...
			#endregion Heavy Lifting Methods
			...
			#endregion Data and Internal Members
		}

		#endregion Enumerator Inner-Class
		...
		#endregion Heavy Lifting Members
