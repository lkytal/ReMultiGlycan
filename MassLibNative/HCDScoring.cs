...
{
	internal class HCDScoring
	{
		private double mdbl_max_mz = 700;
		private double mdbl_min_mz = 0;
		private int mint_min_number_peaks = 2;
		private float[] marr_theoretical_peaks = new float[7];
		private float[] marr_theoretical_hm = new float[7];
		private float[] marr_theoretical_ca = new float[7];
		private float[] marr_theoretical_cs = new float[7];
		private float[] marr_theoretical_hybrid = new float[7];
		private List<int> identified_peak_indices;
