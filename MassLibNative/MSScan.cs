...
namespace COL.MassLib
{
	...
	public class MSScan : ICloneable, IDisposable
	{
		...
		private bool _isCIDScan;
		private bool _isHCDScan;
		private bool _isFTScan;
		...
		{
			get => (_parentMonoMz - Atoms.ProtonMass) * _parentCharge;
			set => _parentMonoMW = value;
		}

		public float ParentAVGMonoMW
		{
			get => _parentAVGMonoMW;
		...
		public int Count => _lstMsPeak.Count;
