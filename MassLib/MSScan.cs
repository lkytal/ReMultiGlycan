...
namespace COL.MassLib
{
    ...
    public class MSScan : ICloneable , IDisposable
    {
        ...
        public float MaxIntensity
        {
            get
            {
                if(_maxIntensity == -10000000000.0f && _intensities.Length>0)
                {
        ...
        public float MinIntensity
        {
            get
            {
                if (_minIntensity == 10000000000.0f && _intensities.Length>0)
                {
        ...
        public float MaxMZ
        {
            get
            {
                if (_maxMZ == -10000000000.0f && _mz.Length > 0)
                {
                    _maxMZ = _mz.Max();
                }
                return _maxMZ;
        ...
        public float MinMZ
        {
            get
            {
                if (_minMZ == 10000000000.0f && _mz.Length > 0)
                {
                    _minMZ = _mz.Min();
                }
                return _minMZ;
